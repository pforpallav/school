...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname pset5final) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
;;; Problem Set 5
;;; Evan Louie
;;; m6d7
...
(check-expect (sort-lop empty) empty)
...
(check-expect (insert-lop POLY3 empty) (cons POLY3 empty))
